...
$(document).ready(function () {
   ...
   $('.calculator .screen .content .questions li').click(function () {
       if(!$(this).closest('.screen').hasClass('screen2') && !$(this).closest('.screen').hasClass('screen4')){
    ...
    $('.slidersall .header nav a').click(function () {
       ...
       if(!$(this).hasClass('active')){
           ...
           if(id==='#carbon'){
               ...
               $('.slidersT470Carousel').slideDown();
           } else if (id==='#t13'){
               $('.slidersT13Carousel').slideDown();
           }
       }
    });
});
...
$(document).ready(function () {
   $('.anchor').click(function () {
       ...
       } else if ($(this).closest('.item').hasClass('itemT470')){
           $('.slidersall .header nav a[href="#t470"]').click();
       } else if ($(this).closest('.item').hasClass('itemT13')){
           $('.slidersall .header nav a[href="#t13"]').click();
       }
       $('body').animate({
