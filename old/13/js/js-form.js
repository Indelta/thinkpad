            ...
            $.ajax({
                ...
                success: function () {
                    if (form.hasClass('slider')){
                        yaCounter45860163.reachGoal('13GetConsultation');
                        ga('send', 'event', 'Btn', 'Click', '13GetConsultation');
                    } else if (form.hasClass('calculator')){
                        yaCounter45860163.reachGoal('13CalculatorConsultation');
                        ga('send', 'event', 'Btn', 'Click', '13CalculatorConsultation');
                    }
                    fbq('track','Lead');
